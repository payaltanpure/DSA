...
class Solution {
    public int maxArea(int[] height) {
        ...
        while(left < right)
        {
            ...
            int height1= Math.min(height[left], height[right]); //find height , take min height of line becoz if taken max water will over flow, to find height we need array elements
...
// Each element in the array represents the height of a vertical line drawn on the x-axis.
...
// Choose two lines such that they form a container that can hold the maximum amount of water.
...
// That is the most important concept in this problem, and once you understand it, the whole two-pointer approach becomes very easy.
...
// So if width decreases, the only way to get a larger area is if the minimum height increases.
...
// If you move the 2-meter wall and find a taller wall, water level can increase.
